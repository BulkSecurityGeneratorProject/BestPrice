package com.aka.bestprice.config;
...
@Configuration
@EnableJpaRepositories("com.aka.bestprice.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.aka.bestprice.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.aka.bestprice.config.HerokuDatabaseConfiguration")
