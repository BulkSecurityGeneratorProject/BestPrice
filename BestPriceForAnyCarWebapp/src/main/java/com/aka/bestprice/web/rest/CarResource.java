...
public class CarResource {
    ...
    @Timed
    public ResponseEntity<Void> create(@RequestBody Car car) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/cars/" + car.getId())).build();
    }
    ...
    @RequestMapping(value = "/cars",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> update(@RequestBody Car car) throws URISyntaxException {
